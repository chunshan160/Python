...
from Web.PageLocators.BOSS.PublishGoods import Local_Life as LL
from Web.PageLocators.BOSS.PublishGoods import Business_Services as BS
...
class PublishGood:
    ...
    # 实物类
    def EntityGood(self, product_title,
    ...
    # 实物类 商超
    def EntityGood_SC(self, product_title,
                      limit_quantity, product_description, property_1, property_2, purchase_price, sell_price,
                      stock):
        # 点击实物商品
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.first_category))).click()
