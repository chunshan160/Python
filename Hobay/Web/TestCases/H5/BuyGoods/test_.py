...
from Web.PageObjects.Web.Index import IndexPage
from Web.PageObjects.Web.SearchGood.SearchGood import SearchGoodPage
from Web.PageObjects.Web import GoodDetailPage
...
class TestBuyGoods:
    ...
    # def test_2_buy_coupon_goods(self, web_buy_goods, data):
    #     doc = "测试购买本地生活商品-"
    #     driver = web_buy_goods
    #     with allure.step("首页点击搜索"):
    #         IndexPage(driver).search(text=doc)
    ...
    # def test_3_buy_server_goods(self, web_buy_goods, data):
    #     doc = "测试购买商企服务商品-"
    #     driver = web_buy_goods
    #     with allure.step("首页点击搜索"):
    #         IndexPage(driver).search(text=doc)
