...
from Common.fengyong.sql.platform_second_payagent_ratio import platform_second_payagent_ratio
from Common.fengyong.sql.second_payagent_ratio import second_payagent_ratio
from decimal import *
