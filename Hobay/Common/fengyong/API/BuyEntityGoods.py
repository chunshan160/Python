...
from Common.fengyong.API.login import login
from Common.fengyong.API.productStockId import get_productStockId
from Common.fengyong.API.address_id import get_address_id
from Common.fengyong.API.SaveOrder import SaveOrder
from Common.fengyong.API.pay import Pay
from Common.fengyong.API.AcceptOrder import AcceptOrder
from Common.fengyong.API.ship import ship
from Common.fengyong.API.suer import suer
