...
def ratio(ip, user_id):
    ...
    print(f"用户等级采购易贝费率是：{user_grade_buy_cbp_ratio}，现金费率是：{user_grade_buy_cash_ratio}，销售现金费率是：{user_grade_sale_cash_ratio}")
    ...
    if user_special_ratio_data != None:
        ...
        print(f"设置的临时采购易贝费率是：{user_special_buy_cbp_ratio}，现金费率是：{user_special_buy_cash_ratio}，销售现金费率是：{user_special_sale_cash_ratio}")
    ...
    if platform_promotion_ratio_data != None:
        ...
        print(f"设置的活动采购易贝费率是：{user_special_buy_cbp_ratio}，现金费率是：{user_special_buy_cash_ratio}，销售现金费率是：{user_special_sale_cash_ratio}")
    ...
    # 只设置活动费率
        ...
        if platform_promotion_buy_cbp_ratio != None and platform_promotion_sale_cash_ratio ==None:
            print("只设置了活动采购费率")
            print("采购费率按照会员等级的采购费率和活动的采购费率做对比，谁低取谁")
        ...
        # 只设置了活动销售费率
            ...
            buy_cbp_ratio = user_grade_buy_cbp_ratio
            buy_cash_ratio = user_grade_buy_cash_ratio
            print("销售费率按照会员等级的销售费率和活动的销售费率做对比，谁低取谁")
            sale_cash_ratio = min(user_grade_sale_cash_ratio, platform_promotion_sale_cash_ratio)

        else:
            print("设置了活动采购+销售费率")
            print("采购费率按照按照会员等级的采购费率和活动的采购费率做对比，谁低取谁")
            buy_cbp_ratio = min(user_grade_buy_cbp_ratio, platform_promotion_buy_cbp_ratio)
            buy_cash_ratio = min(user_grade_buy_cash_ratio, platform_promotion_buy_cash_ratio)
            print("销售费率按照按照会员等级的销售费率和活动的销售费率做对比，谁低取谁")
            sale_cash_ratio = min(user_grade_sale_cash_ratio, platform_promotion_sale_cash_ratio)
    ...
    # 设置了临时费率和活动费率
        ...
        if user_special_buy_cbp_ratio != None and platform_promotion_buy_cbp_ratio != None:
            print("只设置了临时采购费率和活动采购费率")
            print("采购费率按照临时采购费率和活动的采购费率做对比，谁低取谁")
