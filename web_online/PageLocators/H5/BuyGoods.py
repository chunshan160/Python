...
class BuyGoods:
    ...
    #确定
    determine = (By.XPATH, '//div[contains(text(),"确定")]')
    #添加成功msg
    ...
    #选择易贝券
    yibeiquan = (By.XPATH,'//div[contains(text(),"易贝券")]')
    #选择抵工资
    digongzi = (By.XPATH,'//div[contains(text(),"抵工资")]')
    #选择家人购
    jiarengou = (By.XPATH,'//div[contains(text(),"春衫")]')
    #选择现金账户
    xianjinzhanghu = (By.XPATH,'//div[contains(text(),"现金账户")]')
    #确认支付
    confirm_payment = ((By.XPATH,'//div[contains(text(),"确认支付")]'))
    #支付密码
