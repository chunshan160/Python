...
class MyIndex:
    ...
    #test
    delete1=(By.XPATH,'//h4[text()="177****7781"]//..//following-sibling::div[text()="删除"]')
    #mtest
    delete2=(By.XPATH,'//h4[text()="177****7786"]//..//following-sibling::div[text()="删除"]')
    # dev1
    delete3 = (By.XPATH, '//h4[text()="一八八八"]//..//following-sibling::div[text()="删除"]')
