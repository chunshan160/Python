...
#报错截图
error_image=os.path.join(project_path, 'Error_Image', datetime.datetime.now().strftime("%Y-%m-%d")+'Error_Image.png')

#上传图片脚本
upload_image=os.path.join(project_path, 'Source','upload_image.exe')
