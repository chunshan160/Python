...
from TestData.H5.BuyGoods.BuyGoods import *
...
class TestBuyGoods:
    ...
    # def test_1_buy_coupon_goods(self, buy_goods, data):
    #     doc = "测试购买本地生活商品-"
    #     with allure.step("首页点击搜索"):
    #         IndexPage(buy_goods).search(text=doc)
    #     with allure.step("输入商品名-点击第一个商品-"):
    ...
    # def test_1_buy_server_goods(self, buy_goods, data):
    #     doc = "测试购买商企服务商品-"
    #     with allure.step("首页点击搜索"):
    #         IndexPage(buy_goods).search(text=doc)
    #     with allure.step("输入商品名-点击第一个商品-"):
...
if __name__ == '__main__':
    pytest.main(
        ["-v", "-s", "--reruns", "5", "--reruns-delay", "1", "test_BuyGoods.py", "--alluredir",
