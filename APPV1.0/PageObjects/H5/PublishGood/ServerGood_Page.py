...
class ServicesGoodPage(BasePage):
    ...
    def product_title(self, product_title, text=""):
        doc = text + "输入商品标题-"
        self.wait_eleVisible(SG.product_title, doc=doc)
    ...
    def product_description(self, product_description, text=""):
        doc = text + "输入商品详情-"
        self.wait_eleVisible(SG.product_description, doc=doc)
    ...
    def total_price(self, total_price, text=""):
        doc = text + "商品总价-"
        self.wait_eleVisible(SG.total_price, doc=doc)
    ...
    def subsist(self, subsist, text=""):
        doc = text + "预付款-"
        self.wait_eleVisible(SG.subsist, doc=doc)
    ...
    def stock(self, stock, text=""):
        doc = text + "商品库存-"
        self.wait_eleVisible(SG.stock, doc=doc)
    ...
    def limit_quantity(self, limit_quantity, text=""):
        doc = text + "限购数量-"
        self.wait_eleVisible(SG.limit_quantity, doc=doc)
