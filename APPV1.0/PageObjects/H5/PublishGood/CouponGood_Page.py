...
class CouponGoodPage(BasePage):
    ...
    def upload_image(self):
        time.sleep(0.5)
        self.click_element(CG.product_image)

    # 选择图片
    def check_image(self):
        self.click_element(CG.check_image)

    # 点击确定
    def btn_ok(self):
        self.click_element(CG.btn_ok)

    # 输入商品标题
    def product_title(self, product_title):
        time.sleep(0.5)
        UserLog().info("输入的商品标题是:" + product_title)
        self.input_text(CG.product_title,product_title)

    # 输入商品详情
    def product_description(self, product_description):
        time.sleep(0.5)
        UserLog().info("输入商品详情:" + product_description)
        self.input_text(CG.product_description,product_description)

    # 选择分类
    def categpry(self):
        time.sleep(0.5)
        self.click_element(CG.category)

    # 选择二级分类
    def second_categpry(self):
        time.sleep(0.5)
        self.click_element(CG.second_categpry)

    # 选择三级分类
    def third_categpry(self):
        time.sleep(0.5)
        self.click_element(CG.third_categpry)

    # 点击券类
    def coupon(self):
        time.sleep(0.5)
        self.click_element(CG.coupon)

    # 选择券类
    def coupon_categpry(self):
        time.sleep(0.5)
        self.click_element(CG.coupon_categpry, 1)

    # 商品总价
    def total_price(self, total_price):
        time.sleep(0.5)
        UserLog().info("输入的商品总价是:" + total_price)
        self.input_text(CG.total_price,total_price)

    # 商品库存
    def stock(self, stock):
        time.sleep(0.5)
        UserLog().info("输入的商品库存是:" + stock)
        self.input_text(CG.stock,stock)

    # 限购数量
    def limit_quantity(self, limit_quantity):
        time.sleep(0.5)
        UserLog().info("输入的商品限购数量是:" + limit_quantity)
        self.input_text(CG.limit_quantity,limit_quantity)
