...
from TestCases.H5.BuyGoods.test_BuyEntityGoods import BuyEntityGoods
...
class RunTests(object):
    ...
    def run_one(self):
        ...
        test_suite.addTest(loader.loadTestsFromTestCase(BuyEntityGoods))
        ...
        with open(report_path, 'wb') as file:
            runner = HTMLTestReportCN.HTMLTestRunner(stream=file, title=self.title, description=self.description,
                                                     tester="春衫")
