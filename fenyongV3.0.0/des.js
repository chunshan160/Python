export default {
phonerun(e){
	return this.base64encode(this.des('huanbei123456789#$&^#$@%',e,1,1,'01234567',1));
},
runs(e){
var myDate = new Date();
var Month = ((myDate.getMonth()+1))>=10 ? (myDate.getMonth()+1) :('0'+(myDate.getMonth()+1));
var getDate = myDate.getDate()>=10 ? myDate.getDate() : ('0'+myDate.getDate());
var key = myDate.getFullYear()+'-'+ Month +'-'+getDate+'01234567891111';
console.log(key)
	return this.base64encode(this.des(key,e,1,1,'01234567',1));
},
des(K, t, y, u, g, x) {
