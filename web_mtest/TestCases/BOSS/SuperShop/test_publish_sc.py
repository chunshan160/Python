...
from web_mtest.PageObjects.BOSS.Login_page import LoginPage
from web_mtest.PageObjects.ERP.Login_page import LoginPage as lp
from web_mtest.PageObjects.BOSS import PublishGoods_page as PG
from web_mtest.TestData.BOSS import Login_Data as LD
from web_mtest.TestData.ERP import Login
from web_mtest.TestData.BOSS import Publish_SC_Data as PD
from web_mtest.PageObjects.BOSS.SystemPoint_page import SystemPoint
from web_mtest.PageObjects.BOSS.shangchao import ShangChao
from web_mtest.PageObjects.ERP.Check import Check
from web_mtest.PageLocators.BOSS.SC import SC as sc
from web_mtest.PageLocators.BOSS.PublishGoods import Pubilc
from web_mtest.TestData.ERP import GoodCheck
import unittest
from web_mtest.TestData import Common_Data as CD
from selenium.webdriver.support.wait import WebDriverWait
from selenium.webdriver.support import expected_conditions as EC
import ddt
from web_mtest.PageLocators.ERP.Check import Check as CK
from web_mtest.PageObjects.ERP.Good_checked_page import Check as ck
import time
...
class PiblishGoods(unittest.TestCase):
    ...
    @ddt.data(*PD.Real_Goods_1_data)
    def test_1_RealGoods_submit(cls, data):
        # 点击发布实物商品
        cls.pp.Real_Goods_SC(data["product_title"], data["limit_quantity"], data["product_description"],
    ...
    @ddt.data(*PD.Real_Goods_2_data)
    def test_2_RealGoods_submit(cls, data):
        # 点击发布实物商品
        cls.pp.Real_Goods_SC(data["product_title"], data["limit_quantity"], data["product_description"],
                             data["property_1"], data["property_2"], data["purchase_price"], data["sell_price"],
                             data["stock"])
