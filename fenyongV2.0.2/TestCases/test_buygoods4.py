...
from buy_goods.PageObjects.H5_Login_page2 import H5_LoginPage
from buy_goods.PageObjects.Location import Location
from buy_goods.PageLocators.MyIndex import MyIndex
import time
from selenium.webdriver.common.action_chains import ActionChains
from buy_goods.PageObjects.BuyGood_page import BuyGoods
from buy_goods.PageObjects.Untie_Partner import UntiePartner
...
from buy_goods.PageObjects.Recharge import Recharge
from buy_goods.PageObjects.Seach_Goods import Seach_Goods
from buy_goods.PageObjects.Receipt_Delivery import ReceiptDelivery
...
class TestBuyGoods(unittest.TestCase):
    ...
    def test_1_buy_goods(self, item):
        ...
        if "实物商品" in item['goodsname']:
            ...
            ReceiptDelivery(driver).local_life(H5_Login_url, H5_home_url, buyer_phone, seller_phone)
