...
def bug_goods(buyer_phone, seller_phone, productId, payType):
    ...
    a=product_res.json()['data']['result']
    # print(a)
    # print(len(a))
    for i in range(0,len(a)):
        if a[i]['title']=='普通焕商商企服务':
            b=a[i]['productStockWithStockImages'][0]['id']
    print(b)
...
if __name__ == '__main__':
    bug_goods(17777777781, 17777777776, 1079559, 3)
