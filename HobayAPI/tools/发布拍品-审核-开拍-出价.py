...
def auction(buyer_phone, seller_phone,goods_name="发布拍品用"):
    ...
    # 发布拍品
    SaveOrder_url = 'http://m.dev1.hobay.com.cn/ribbon-api/auctionOlBid/publishAuction'
    ...
    # operate登录
    login2_url = 'http://operate.dev1.hobay.com.cn/adminuser/userLogin'  # 登录
    login2_data = {
    ...
    preEndTime = data_time + 1000000
    print(preBeginTime, preEndTime)
    url = 'http://operate.dev1.hobay.com.cn/auctionolproduct/passCheckNew'  # 登录
    ...
    # 卖家设置开拍时间
    signed_url = "http://m.dev1.hobay.com.cn/ribbon-api/auctionOlBid/starAuction"
    ...
    # 参与者登录
    login3_url = 'http://m.dev1.hobay.com.cn/api/app/user/login'  # 登录
    ...
    # 获取收货地址
    address_url = "http://m.dev1.hobay.com.cn/api/user/graphql/flat"
    address_data = {
    ...
    SaveOrder_url = "http://m.dev1.hobay.com.cn/ribbon-api/auctionOlProduct/enrollAndPay"
    ...
    pay_url = "http://m.dev1.hobay.com.cn/ribbon-api/pay/payCash"
    ...
    # 出价
    time.sleep(5)
    chujia_url = "http://m.dev1.hobay.com.cn/ribbon-api/auctionOlBid/bidPrice"
...
if __name__ == '__main__':
    auction(17777777781, 13724765586)