...
from web_test2.PageObjects.H5 import PublishGoods_cash_page as PG
import unittest
...
class PiblishGoods(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # cls.driver.set_window_size(375,950)
    ...
    # 发布实物商品，立即上架
    @ddt.data(*PD.Real_Goods_cash_data)
    ...
    # 发布本地生活，立即上架
    @ddt.data(*PD.Local_Life_cash_data)
    ...
    # 发布商企服务，立即上架
    @ddt.data(*PD.Business_Services_cash_data)
