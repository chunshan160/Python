...
class BuyGoods(unittest.TestCase):
    ...
    def setUp(cls):
        time.sleep(3)
        # 滚动至元素【本地生活】可见，点击【更多】
        ActionChains(cls.driver).move_to_element(cls.driver.find_element(*Home.business_services_title)).perform()
        cls.driver.execute_script('window.scrollBy(0,500)')
        cls.driver.find_element(*Home.business_services_more).click()
        time.sleep(2)
    ...
    # 购买商企服务
    def test_1_BusinessServices(self):
        # 点击【商企服务】
        self.driver.find_element(*Home.business_services_goods).click()
        time.sleep(6)
        # 购买流程
        # 立即购买
    ...
    # 购买商企服务
    def test_2_BusinessServices(self):
        # 点击【商企服务】
        self.driver.find_element(*Home.business_services_goods).click()
        time.sleep(6)
        # 购买流程
    ...
    # 购买商企服务
    def test_3_BusinessServices(self):
        # 点击【商企服务】
        self.driver.find_element(*Home.business_services_goods).click()
        time.sleep(6)
        # 购买流程
    ...
    # 购买商企服务
    def test_4_BusinessServices(self):
        # 点击【商企服务】
        self.driver.find_element(*Home.business_services_goods).click()
        time.sleep(6)
        # 购买流程
    ...
    # 购买商企服务
    def test_5_BusinessServices(self):
        # 点击【商企服务】
        self.driver.find_element(*Home.business_services_goods).click()
        time.sleep(6)
        # 购买流程
