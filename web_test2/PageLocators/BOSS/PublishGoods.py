...
class Real_Goods:
    ...
    first_category = (By.XPATH, '//li[contains(text(),"实物商品")]')
    # 第二分类
    second_categpry = (By.XPATH, '//li[text()="房产"]')
    # 第三分类
    ...
    #是
    yes = (By.XPATH,'//span[text()="是"]//parent::li')
    #商超列表
    supermarket_list = (By.XPATH,'//div[@class="el-col el-col-12"]/div[@class="el-select"]')
    #测试专用（审核专属限制qm）
    supermarket_name = (By.XPATH,'//span[text()="测试专用（审核专属限制qm）"]//parent::li')
    #是否现金商品
    cash = (By.XPATH,'//label[contains(text(),"是否现金商品")]//..//div[@class="el-select"]')
...
class Local_Life:
    ...
    # 第二分类
    second_categpry = (By.XPATH, '//li[text()="住宿"]')
    # 第三分类
    third_categpry = (By.XPATH, '//li[text()="快捷酒店"]')
    # 商品名称
    product_title = (By.XPATH, '//*[contains(text(),"商品名称")]//following-sibling::div//div//input')
    # 点击卡券种类
...
class Business_Services:
    ...
    second_categpry = (By.XPATH, '//li[text()="房产"]')
    # 第三分类
    third_categpry = (By.XPATH, '//li[text()="公寓"]')
    # 商品名称
    product_title = (By.XPATH, '//*[contains(text(),"商品名称")]//following-sibling::div//div//input')
    # 总价
