...
class Pubilc:
    ...
    # 上传图片的脚本
    path = ('D:\pycharm_workspace\web\image.exe')
    # 立即上架
...
class Real_Goods:
    ...
    # 二级分类
    second_categpry = (By.XPATH, '//div[text()="房产"]')
    # 三级分类
    third_categpry = (By.XPATH, '//li[text()="住宅"]')
    # 商品类型
    product_type = (By.XPATH, '//label[text()="商品类型"]//parent::div')
    # 商品类型
    product_type_select_yibei = (By.XPATH, '//*[contains(text(),"易贝商品")]//span')
    product_type_select_cash = (By.XPATH, '//*[contains(text(),"现金商品")]//span')
    # 规格
...
class Local_Life:
    ...
    # 点金现金商品
    cash = (By.XPATH, '//div[@class="van-switch"]')
    # 分类
    classification = (By.XPATH, '//label[text()="分类"]//parent::div')
    # 二级分类
    classification_Secondary = (By.XPATH, '//div[text()="美食"]')
    # 三级分类
    classification_Third_grade = (By.XPATH, '//li[text()="外卖"]')
    # 点击券类
...
class Business_Services:
    ...
    classification = (By.XPATH, '//label[text()="分类"]//parent::div')
    # 二级分类
    classification_Secondary = (By.XPATH, '//div[text()="广告媒体"]')
    # 三级分类
    classification_Third_grade = (By.XPATH, '//li[text()="新媒体广告"]')
    # 总价
    total_price = (By.XPATH, '//input[@placeholder="商品总价"]')
    # 预付款
