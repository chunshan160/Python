...
from web_test2.PageLocators.BOSS.PublishGoods import Real_Goods as RG
...
from web_test2.PageLocators.BOSS.PublishGoods import Local_Life as LL
from web_test2.PageLocators.BOSS.PublishGoods import Business_Services as BS
...
class Product:
    ...
    # 实物类现金
    def Real_Goods_cash(self, product_title,
                        limit_quantity, product_description, property_1, property_2, purchase_price, sell_price,
                        stock):
        # 点击实物商品
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.first_category))).click()
        ...
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.quality_new))).click()
        # 点击是否现金商品
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.cash))).click()
        time.sleep(1)
        # 选择是
        self.driver.find_elements(*RG.yes)[1].click()
        # 输入限购数量
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.limit_quantity))).send_keys(
            limit_quantity)
        # 点击运费
    ...
    def Real_Goods_SC(self, product_title,
        ...
        # 选择是
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.yes))).click()
        # 点击商超列表
    ...
    # 本地生活-现金
    def Local_Life_cash(self, product_title, total_price, stock, limit_quantity, product_description):
        # 点击本地生活
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((LL.first_category))).click()
        # 点击本地生活-酒水
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((LL.second_categpry))).click()
        ...
        time.sleep(1)
        # 选择是
        self.driver.find_element(*RG.yes).click()
        # 输入限购数量
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((LL.limit_quantity))).send_keys(
            limit_quantity)
        # 上传主图
    ...
    def Business_Services_cash(self, product_title, total_price, subsist, stock, limit_quantity, product_description):
        # 点击商企服务
