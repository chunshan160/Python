...
class Product:
    ...
    def Real_Goods(self, product_title, product_description, property_1, property_2, purchase_price, sell_price, stock,
        ...
        time.sleep(2)
        # 选择商品类型
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.product_type_select_cash))).click()
        time.sleep(2)
        # 点击规格
    ...
    def Local_Life(self, product_title, product_description, total_price, stock, limit_quantity):
        ...
        WebDriverWait(self.driver, 10).until(
            ...
            product_description)
        # 选择现金商品
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((BS.cash))).click()
        time.sleep(2)
        # 选择分类
        WebDriverWait(self.driver, 10).until(
