...
from web_test2.PageLocators.H5.PublishGoods import Real_Goods as RG
from web_test2.PageLocators.H5.PublishGoods import Local_Life as LL
from web_test2.PageLocators.H5.PublishGoods import Business_Services as BS
...
class Product:
    ...
    def Real_Goods(self, product_title, product_description, property_1, property_2, purchase_price, sell_price, stock,
        ...
        # 选择分类
        WebDriverWait(self.driver, 20).until(EC.visibility_of_element_located((RG.category))).click()
        # 选择二级分类
        ...
        time.sleep(2)
        # 选择商品类型
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((RG.product_type_select_yibei))).click()
        time.sleep(2)
        # 点击规格
