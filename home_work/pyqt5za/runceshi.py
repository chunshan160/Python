...
from learn.DataDisplayUI import Ui_MainWindow
...
class ImgDisp(QMainWindow, Ui_MainWindow):
    ...
    def PrepareBarCanvas(self):
        ...
        self.BarFigure.ax.set_ylim(0, 1)
        self.bar = self.BarFigure.ax.bar(np.arange(0 ,4, 1), np.sin(np.arange(0, 4, 1)), width=1)
